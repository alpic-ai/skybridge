...
type ProductCardProps = {
  ...
  outOfStock?: boolean;
  badges?: string[]; // D1: metadata.tags (New/Bestseller)
  rating?: number; // D1: 0–5
  reviewCount?: number;
};

// D2: each card is boxed; the carousel stays unframed.
const FRAMED = true;
  ...
  return (
    <article className={styles.card({ framed: FRAMED })}>
      ...
      <div className={styles.body}>
        ...
        {rating != null ? (
          <p className={cx(text({ style: "bodyS" }), styles.rating)}>
