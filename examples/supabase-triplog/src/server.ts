      ...
      .registerTool(
        {
          ...
          inputSchema: {
            ...
            cover_url: z
              ...
              .url()
              .optional()
              .describe("Public cover image URL"),
            date: z
              .string()
      ...
      .registerTool(
        {
          ...
          inputSchema: {
            ...
            expenses: z
              ...
              .min(0)
              .optional()
              .describe("New total amount spent"),
            cover_url: z
              .string()
              .url()
              .optional()
        ...
        async (input) => {
          try {
            ...
            if (Object.keys(updates).length === 0) {
              return {
                content: [
                  {
                    type: "text",
                    text: "Nothing to update — no fields provided.",
                  },
                ],
                isError: false,
              };
            ...
            return {
              content: [
                { type: "text", text: `Trip ${id} updated successfully.` },
              ],
              isError: false,
            };
          } catch (error) {
          ...
          try {
            ...
            return {
              content: [
                {
                  type: "text",
                  text: `Trip ${input.id} deleted successfully.`,
                },
              ],
              isError: false,
            };
