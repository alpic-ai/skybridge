 ...
 *
 * This is the in-place model: every axis is local state, no remount. Our axes
 * (Color, Material, Length) are all within-product variants, so chips fit; no
 * axis needs promotion to a cross-product switch.
 */
