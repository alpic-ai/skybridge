...
export const slide = style({
  ...
  // Reserve the box so images load without shifting the page. Same 1:1 + cover
  // as the card (phase 2: square full-bleed lifestyle photos).
  aspectRatio: "1",
...
// max-height and scrolls the excess. (Unused: D4 keeps the rail off.)
