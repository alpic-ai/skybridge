...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    creatingSession: "Redirecting to Stripe\u2026",
  ...
  fr: {
    ...
    creatingSession: "Redirection vers Stripe\u2026",
  ...
  es: {
    ...
    creatingSession: "Redirigiendo a Stripe\u2026",
  ...
  de: {
    ...
    creatingSession: "Weiterleitung zu Stripe\u2026",
