...
### Connect to ChatGPT
Provide the user with these instructions to create the plugin in ChatGPT:
1. Go to [ChatGPT Plugins](https://chatgpt.com/plugins) and select the **+** button
2. Enter a name and description for the plugin
3. Paste this URL: `{tunnel-url}/mcp`
4. Set the appropriate Authentication scheme. In doubt, pick "No Authentication"
5. Create the connection
6. Test by typing `@{plugin-name}` in a ChatGPT chat

**Troubleshooting:**
- **+** button missing: ask user to enable Developer mode in Settings → Security and login → Developer mode
- **+** button not working: confirm they have ChatGPT Plus, Pro, Business, or Enterprise/Edu plan


### Connect to Claude
Provide the user with these instructions to create the connector in Claude:
