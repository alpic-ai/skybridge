...
| Assert on the tools the model calls, in CI | [Evals](/test/evals) | <Icon icon="check" color="#22C55E" /> | <Icon icon="x" color="#EF4444" /> | <Icon icon="x" color="#EF4444" /> |
...
<Columns cols={2}>
    ...
    <Card title="Evals" icon="flask-conical" href="/test/evals">
        Assert on the tool calls a real model makes
    </Card>
