...
#### Customize the Connector icon

Skybridge passes the first `McpServer` argument through as MCP implementation metadata. Add an `icons` array there to advertise the Connector icon to Claude and other MCP clients that support implementation icons:
