---
title: Migrate
description: "Migrate an existing ChatGPT Apps SDK or MCP ext-apps project to Skybridge automatically with the Skybridge skill running in your AI coding agent."
