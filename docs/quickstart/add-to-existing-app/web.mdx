...
Here's a simple widget using Skybridge hooks. Widgets live in `src/views/` and `export default` a React component — the Vite plugin auto-mounts them.

```tsx
// src/views/my-widget.tsx
