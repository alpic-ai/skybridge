---
title: Quickstart
description: "Scaffold a fully working MCP or ChatGPT app in five minutes with the create-skybridge starter template, DevTools, and an end-to-end typed example."
icon: "bolt"
iconType: "regular"
---
