...
The widget file name must match `view.component` in `registerTool` (e.g., `component: "my-widget"` → `src/views/my-widget.tsx`). See [registerTool](/api-reference/register-tool).
</Warning>
