...
<Tip>
**Don't know if you should start with a ChatGPT or MCP App?** It doesn't matter! With Skybridge, you build your App once, and it runs seamlesly with both runtimes.
</Tip>
