...
description: "Add Skybridge to an existing MCP server or React app for interactive view support, hooks, and end-to-end TypeScript inference without a rewrite."
---
