---
title: Skills
description: "Install the Skybridge skill in Claude Code, Cursor, and other AI coding agents to scaffold, migrate, debug, and deploy MCP and ChatGPT apps faster."
---
