...
The model composes the interface at runtime. Each example uses a different rendering approach — JSON specs, streaming markup, and more later.
...
<ChatExample
  ...
  alt="OpenUI showcase"
  description="LLM-generated dynamic UIs with OpenUI Lang and the standard OpenUI component library. The AI streams OpenUI Lang; the view renders it progressively."
...
Ready-made component kits you drop into a Skybridge view.
