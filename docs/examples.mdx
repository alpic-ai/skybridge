...
<ChatExample
  ...
  description="Handles ChatGPT file attachments end to end: compresses a file into a downloadable .zip, stores it in Cloudflare R2, and returns a presigned link. Uses the ChatGPT `window.openai` file APIs."
