...
<Card
  ...
  img="/images/showcase-supabase-triplog.png"
  href="/examples/supabase-triplog"
>
  Personal trip log backed by Supabase, with CRUD tools, UI filtering, focused trip views, and cover image browsing.

  <a href="https://github.com/alpic-ai/skybridge/tree/main/examples/supabase-triplog" target="_blank" onClick={(e) => e.stopPropagation()}><Icon icon="github" iconType="brands" /> View code on GitHub</a>
</Card>
