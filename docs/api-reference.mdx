...
| Hook | Apps SDK | MCP Apps | Notes |
|------|:--------:|:--------:|-------|
| [useToolInfo](/api-reference/use-tool-info) | ✅ | ✅ | |
| [useWidgetState](/api-reference/use-widget-state) | ✅ | 🔜 | MCP Apps: coming soon |
...
| [useRequestModal](/api-reference/use-request-modal) | ✅ | 🔜 | MCP Apps: coming soon |

<Tip>
Learn more about runtime differences in [Platform Agnosticism](/concepts/platform-agnosticism).
</Tip>
