...
Use `generateHelpers` for autocomplete and type inference. See [generateHelpers](/api-reference/utilities/generate-helpers) for setup.
...
- [useToolInfo API](/api-reference/hooks/use-tool-info)
- [useCallTool API](/api-reference/hooks/use-call-tool)
