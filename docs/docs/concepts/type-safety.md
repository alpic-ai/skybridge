...
## Method Chaining Requirement {#method-chaining}

:::warning Required for type inference
...
- [generateHelpers API](/api-reference/utilities/generate-helpers) - Full API documentation
- [Type Utilities](/api-reference/types/infer-utility-types) - Type extraction helpers
