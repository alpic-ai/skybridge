...
# Fast Iteration: Local Development without ChatGPT
...
<a href="/img/emulator.png" target="_blank">
  <img src="/img/emulator.png" alt="Skybridge DevTools Emulator" style={{maxWidth: '100%', borderRadius: '8px', border: '1px solid #e0e0e0'}} />
</a>
...
:::info Starter template required
...
- [useLayout API](/api-reference/hooks/use-layout) - Access theme and layout info
- [useCallTool API](/api-reference/hooks/use-call-tool) - Make tool calls from widgets
