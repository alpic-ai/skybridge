...
// `claude`, `cursor`, and/or `goose`; hosts render in lexicographic order. SVGs
// are inlined so fills can follow the theme: Alpic is always #ed115e, Claude
// keeps its brand orange, and ChatGPT/Cursor/Goose use currentColor (black in
