...
Register an interactive widget with UI. See [registerWidget](/api-reference/register-widget) for details.
...
- [registerWidget](/api-reference/register-widget) - Widget registration details
