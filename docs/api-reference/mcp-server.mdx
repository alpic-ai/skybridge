---
title: McpServer
description: "The main class for building MCP servers with Skybridge, supporting tools, widgets, and type inference."
---
...
Register a tool — with or without a React widget — using a single unified call. Provide `view` to bind the tool to a widget; omit it for a plain tool. See [registerTool](/api-reference/register-tool) for the full API.
...
- [registerTool](/api-reference/register-tool) - Tool/widget registration details
