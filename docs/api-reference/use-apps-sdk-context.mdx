...
description: "API reference for useAppsSdkContext: low-level React hook to subscribe directly to OpenAI ChatGPT Apps SDK host global state values from views."
tag: "ChatGPT"
---
