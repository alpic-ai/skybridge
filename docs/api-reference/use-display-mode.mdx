...
description: "API reference for useDisplayMode: read and switch view display modes in MCP and ChatGPT hosts, including inline, fullscreen, and picture-in-picture."
---
