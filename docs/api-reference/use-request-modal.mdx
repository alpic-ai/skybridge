...
<Warning>
**Runtime Support**: Apps SDK (ChatGPT) | MCP Apps (coming soon)

MCP Apps support is planned. Modals will render inside the widget iframe rather than being portaled to the host.
</Warning>
