...
description: "Trigger modals portaled outside the widget iframe for better overlay display."
tag: "ChatGPT"
---

<Warning>
**Runtime Support**: ChatGPT Apps | MCP Apps (polyfilled)

In MCP Apps, `useRequestModal` is polyfilled. Modals render inside the widget iframe rather than being portaled to the host.
</Warning>
