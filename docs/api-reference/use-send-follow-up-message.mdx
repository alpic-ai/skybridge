...
description: "API reference for useSendFollowUpMessage: programmatically trigger an AI conversation turn from your view based on user actions or view state."
---
