...
description: "Programmatically trigger AI conversation turns based on user actions in your widget."
---

The `useSendFollowUpMessage` hook returns a function to programmatically trigger a follow-up turn in the AI conversation. This allows your widget to prompt the model to continue the conversation based on user actions.
