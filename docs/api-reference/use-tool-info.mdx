---
title: useToolInfo
description: "API reference for useToolInfo: React hook to read the calling tool's typed input, structured output, metadata, and execution status from views."
---
