...
description: "API reference for useSetOpenInAppUrl: set the destination URL ChatGPT opens when users tap the 'open in app' button on your fullscreen app view."
tag: "ChatGPT"
---
