...
<Warning>
**Runtime Support**: In MCP Apps, `data-llm` is polyfilled with the same limitation as [useWidgetState](/api-reference/use-widget-state): state does not persist across widget renders.
</Warning>
