...
description: "API reference for the data-llm HTML attribute that exposes view UI state to the LLM for contextual, follow-up responses without extra tool calls."
---
