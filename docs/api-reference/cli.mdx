...
| `--claude` | Enable the Claude Code harness (beta). Starts a Claude terminal inside DevTools connected to your MCP server. Requires `claude` CLI to be installed and authenticated locally. |
