...
description: "Reference for Skybridge TypeScript type utilities: extract tool input, output, and structured content types directly from your MCP server definition."
---
