---
title: useLayout
description: "API reference for useLayout: access dynamic viewport dimensions, theme, safe area, and visual environment from MCP and ChatGPT app views in React."
---
