...
description: "API reference for useRequestSize: programmatically resize an MCP or ChatGPT app view to specific width and height dimensions from inside the iframe."
---
