...
description: "Deep dive into the ChatGPT Apps SDK runtime: MCP Apps compatibility, the window.openai API, fullscreen and PiP modes, and ChatGPT-only features."
---
