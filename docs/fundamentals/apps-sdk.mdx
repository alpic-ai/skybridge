...
| `window.openai.widgetState` | [`useWidgetState()`](/api-reference/use-widget-state) | Persistent widget state |
...
| `window.openai.displayMode` | [`useDisplayMode()`](/api-reference/use-display-mode) | Access/change display mode |
