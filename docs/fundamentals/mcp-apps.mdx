...
description: "Deep dive into the MCP ext-apps specification: how the MCP protocol exposes views, how Skybridge hooks map to it, and how MCP clients render apps."
---
