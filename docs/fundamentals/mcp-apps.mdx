...
Since DevTools currently uses the Apps SDK runtime, testing MCP Apps requires:
...
- [Write Once, Run Everywhere](/concepts/write-once-run-everywhere) - How Skybridge abstracts these differences
