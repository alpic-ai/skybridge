...
description: "Capitals Explorer example: an interactive world map with geolocation, Wikipedia data, and dynamic capital exploration built as a Skybridge MCP app."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="github"
    href="https://github.com/alpic-ai/skybridge/tree/main/examples/capitals"
  >
