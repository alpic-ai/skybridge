...
description: "Investigation Game example: an interactive murder mystery MCP app with multi-screen gameplay, fullscreen mode, and follow-up message driven story progression."
---
...
<CardGroup cols={2}>
  <Card
    title="Try the demo"
    icon="play"
    href="https://investigation-game.skybridge.tech/try"
  >
  ...
  <Card
    ...
    icon="github"
    href="https://github.com/alpic-ai/skybridge/tree/main/examples/investigation-game"
  >
