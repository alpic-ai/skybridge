---
title: Generative UI
description: "Generative UI example: a Skybridge MCP app where the LLM composes dynamic interfaces with json-render and shadcn/ui components rendered inside ChatGPT."
---
