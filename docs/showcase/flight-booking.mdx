...
description: "Flight booking example: a Skybridge MCP app with a flight search carousel, route details, pricing comparison, and external booking links inside ChatGPT."
---
...
<CardGroup cols={2}>
  <Card
    title="Try the demo"
    icon="play"
    href="https://flight-booking.skybridge.tech/try"
  >
  ...
  <Card
    ...
    icon="github"
    href="https://github.com/alpic-ai/skybridge/tree/main/examples/flight-booking"
  >
