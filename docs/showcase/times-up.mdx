---
title: Time's Up
description: "Time's Up example: a Skybridge MCP party game where the user gives hints and the AI guesses words, featuring picture-in-picture mode and multilingual support."
---
