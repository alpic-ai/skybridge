---
title: Manifest UI
description: "Manifest UI example: an agentic component library for Skybridge that lets the LLM compose rich, interactive views from structured tool output in MCP apps."
---
