...
This covers *view* state: what's on screen, scoped to one conversation. For the data your tools read and write on the server, such as a product catalog or a CRM, see [Persist Server Data](/guides/data-persistence).
