...
While `setWidgetState` pushes structured data to the model context, `data-llm` describes what the user currently sees in natural language. It's recomputed on every render and synced to the model:
