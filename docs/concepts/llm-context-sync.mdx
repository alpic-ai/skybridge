...
description: "Sync your app view's UI state to the LLM with data-llm attributes so the model has accurate context for follow-up answers and conversational turns."
---
