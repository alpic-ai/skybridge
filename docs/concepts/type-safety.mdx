...
The Vite plugin scans `src/views/` and generates `.skybridge/views.d.ts`. That file augments an internal `ViewNameRegistry` interface, narrowing `ViewName` from `string` to the union of your actual view file names.
