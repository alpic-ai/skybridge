---
title: Type Safety
description: "Get end-to-end TypeScript type inference from your MCP server to your React views using generateHelpers, eliminating manual schema duplication."
---
