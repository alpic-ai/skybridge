---
title: Data Flow
description: "Learn how data flows between the host, your MCP server, and React views in Skybridge apps, including tool calls, structured output, and view state."
---
