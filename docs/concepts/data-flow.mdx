...
Before diving into the data flow, understand the difference between plain tools and tools returning a view. Both use `registerTool`, differentiated by the optional `view` field:
