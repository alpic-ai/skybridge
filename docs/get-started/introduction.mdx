...
<Columns cols={3}>
    <Card title="Architecture" icon="route" href="/get-started/architecture">
        Design experiences leveraging models intelligence.
    </Card>
...
Skybridge is built around all three; it's the fastest, most complete way to build full-fledged MCP Apps. Protocol, authentication, and host support are baked in. It comes with a dead-simple architecture and a complete tooling suite, including HMR, inspector, tunneling, playground, and deployment. Your sole focus: what makes your app great.
