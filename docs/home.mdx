...
description: "Skybridge is a TypeScript framework for building MCP Apps and ChatGPT Apps with React views, end-to-end type safety, local DevTools, and easy deploys."
