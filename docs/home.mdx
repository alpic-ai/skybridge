...
**Skybridge** bridges the gap between standard **MCP servers** and host runtimes ([Apps SDK](https://developers.openai.com/apps-sdk/reference/), [MCP Apps](https://github.com/nicobrinkkemper/ext-apps)), allowing you to build rich, React-based UI experiences directly within AI conversations—all with full type safety and a developer experience you'll love.
