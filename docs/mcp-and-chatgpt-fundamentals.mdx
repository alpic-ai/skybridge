---
title: MCP and ChatGPT Apps Fundamentals
sidebarTitle: "MCP Fundamentals"
description: "Essential background on the protocols and SDKs that Skybridge builds upon for widget development."
---
...
<Note>
Read our [in-depth blog article](https://alpic.ai/blog/inside-openai-s-apps-sdk-how-to-build-interactive-chatgpt-apps-with-mcp?ref=makerswave.com) to understand how ChatGPT Apps work
</Note>
