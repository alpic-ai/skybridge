...
Lulu also ships [result widgets](https://github.com/Lulu-The-Narwhal/lulu-ads#result-widgets), ready-made templates that render your own tool output with the sponsored strip built in, for hosts that support rendered widgets.
