...
<Info>
If your app calls `window.openai` or the `ext-apps` protocol directly, the [feature mapping](/resources/chatgpt-and-mcp-apps#feature-mapping) gives the Skybridge hook that replaces each one.
</Info>
