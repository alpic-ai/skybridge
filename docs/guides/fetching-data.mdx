---
title: Fetching Data
description: "Two patterns for getting data into Skybridge app views: initial hydration from tool output with useToolInfo, and user-triggered fetching with useCallTool."
---
