...
<Columns cols={2}>
    ...
    <Card title="Assets and Styling" icon="image" href="/guides/assets-and-styling">
        Ship images, fonts and stylesheets with your views
    </Card>
    ...
    <Card title="Persist Server Data" icon="hard-drive" href="/guides/data-persistence">
        Keep the data your tools read and write past a single request
    </Card>
