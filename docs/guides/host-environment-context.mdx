...
description: "Adapt Skybridge app views to host theme, locale, timezone, display mode, and device using useLayout, useUser, and useDisplayMode environment hooks."
---
