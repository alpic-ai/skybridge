...
description: "Send view state to the LLM with data-llm for passive context sync, and trigger conversation turns actively from views using useSendFollowUpMessage."
---
