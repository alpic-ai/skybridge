...
description: "Manage local and global state in Skybridge views: persist data across renders with useViewState, and share state with Zustand stores via createStore."
---
