...
<img src="/images/files.png" alt="Files Illustration" style={{ width: "100%", maxHeight: "40vh", marginTop:"-0.75rem", objectFit: "cover", borderRadius: "15px" }} />

Views run in a sandboxed iframe, cut off from the conversation and the user's disk. Each host opens its own door for files, and the two work differently: ChatGPT stores files and passes them in and out of your tools and views; Claude only lets a view save a file to the user's device. What you can build depends on the host.
