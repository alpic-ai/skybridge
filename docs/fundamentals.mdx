---
title: Fundamentals
description: "Understand the Model Context Protocol, the MCP Apps portable baseline for interactive views, and the ChatGPT Apps SDK extensions Skybridge unifies."
---
