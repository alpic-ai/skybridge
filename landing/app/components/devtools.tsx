        ...
        <div className="sb-dp-diff">
          ...
          <div className="sb-dp-diff-body">
            ...
            <div className="sb-dp-diff-line sb-dp-diff-del">
              ...
              <span className="sb-c-punc">={"{"}output{"}"}</span>{" "}
      ...
      >
        ...
        <div className="sb-dp-tun-diagram">
          ...
          >
            ...
            <line x1="90" y1="2" x2="22" y2="30" stroke="rgba(137,240,236,0.35)" strokeWidth="1" strokeDasharray="3 2" markerEnd="url(#arr-l)" />
            <line x1="90" y1="2" x2="158" y2="30" stroke="rgba(137,240,236,0.35)" strokeWidth="1" strokeDasharray="3 2" markerEnd="url(#arr-r)" />
          </svg>
